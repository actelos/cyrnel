...
See [Module interfaces](/cyrnel/sdk-spec/5.0.0/module) and the Module Specification
...
[definitions semantics](/cyrnel/registry-specs/v1/definitions#version-selection):
