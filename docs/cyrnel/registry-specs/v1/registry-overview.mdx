...
- **Definitions**: machine-readable service definitions that adapters turn into
  installable services with tools.
...
- **Operators** run Cyrnel and point it at registries. The management
  surface is covered in [Manage registries](/cyrnel/docs/v1/registries) and
  [Registry management API](/cyrnel/registry-specs/v1/registry-management-api).

## Capabilities

A registry advertises its content through a
[well-known document](/cyrnel/registry-specs/v1/well-known) with capability
keys:
