...
[callback surface](/cyrnel/module-specs/environment-bindings), store it and use it to
report execution state, capture I/O, and forward tool discovery /
invocation requests. `logger` is the host-owned
[`ModuleLogger`](/cyrnel/module-specs/types#modulelogger), store it and use it for
...
See [`EnvironmentBindings`](/cyrnel/module-specs/environment-bindings) for the callbacks and
[Execution](/cyrnel/module-specs/environment-execution) for the state machine details.
