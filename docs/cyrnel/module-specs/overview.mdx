...
- **Adapter authors** implement [`AdapterModule`](/cyrnel/module-specs/adapter-module).
- **Environment authors** implement
  [`EnvironmentModule`](/cyrnel/module-specs/environment-module).
- **Cyrnel itself** implements [`EnvironmentBindings`](/cyrnel/module-specs/environment-bindings),
...
- **Custom modules** declare basic metadata in `module.json` and the
  ...
  [Writing a custom module](/cyrnel/module-specs/writing-custom-modules) for
  the full layout.
