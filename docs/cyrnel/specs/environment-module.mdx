...
[callback surface](/specs/environment-bindings), store it and use it to
...
See [`EnvironmentBindings`](/specs/environment-bindings) for the callbacks and
[Execution](/specs/environment-execution) for the state machine details.
