...
interface reference see [`AdapterModule`](/specs/adapter-module).
...
See [`ServiceState`](/specs/types#servicestate-and-toolstate) for the shape
of the snapshot the host delivers to `hydrateService`, and
[`AdapterModule`](/specs/adapter-module) for the full interface contract.
