...
| `CYRNEL_EMBEDDING_MODEL` | `Xenova/bge-small-en-v1.5` | Local ONNX embedding model to download and load |
| `CYRNEL_RECONCILE_INTERVAL_MS` | `1800000` | Reconciliation interval in ms for syncing embeddings (default: 30 min) |
