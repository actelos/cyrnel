...
[`EnvironmentModule`](/cyrnel/module-specs/environment-module) interface.
...
1. **`setup({ bindings })`** is called when the environment is activated.
   `bindings` is the [`EnvironmentBindings`](/cyrnel/module-specs/environment-bindings) callback
...
See [Writing a custom environment module](/cyrnel/module-specs/writing-custom-environment-module)
for the file layout, a skeleton, and a full working example.
[`EnvironmentModule`](/cyrnel/module-specs/environment-module) covers the interface
contract in full, and [`EnvironmentBindings`](/cyrnel/module-specs/environment-bindings)
