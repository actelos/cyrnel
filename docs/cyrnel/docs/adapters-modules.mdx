...
Adapter modules implement the SDK [`AdapterModule`](/cyrnel/module-specs/adapter-module)
interface.
...
See [Writing a custom adapter module](/cyrnel/module-specs/writing-custom-adapter-module)
for the file layout, a skeleton, and a full working example.
[`AdapterModule`](/cyrnel/module-specs/adapter-module) covers the interface contract
in full.
