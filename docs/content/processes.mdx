...
See [Architecture](/architecture) for how processes fit into the overall system: environments execute code, adapters perform service invocations, and pools manage module lifecycle.
